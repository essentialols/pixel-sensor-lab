...
| 2   | **Magnetometer**                  | AK09918 (AKM)         | AOC sensor hub                                 | Raw 3-axis magnetic field. Metal detection, indoor positioning, geomagnetic fingerprinting.                                                                                   | Medium     |
...
| 6   | **Fingerprint sensor**            | Goodix (optical UDFS) | `goodixfp.ko`                                  | Raw optical imaging through OLED. Material reflectance, subsurface vein patterns, pulse/SpO2. Driver source is closed -- true binary RE.                                      | Very high  |
