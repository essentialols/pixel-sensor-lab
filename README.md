...
| EdgeTPU (CPA/matmul)  | DarwiNN v2      | `edgetpu_platform` (`/dev/janeiro`) | [pixel-tpu-cpa](../pixel-tpu-cpa) (canonical repo)      | **E053** -- 53+ experiments, full firmware decompile, 4.29 TOPS INT4 measured, 1.92 TOPS INT8 |
